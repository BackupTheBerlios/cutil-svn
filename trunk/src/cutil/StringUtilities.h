...
#ifndef _CUTIL_STRINGUTILITIES_H_
#define _CUTIL_STRINGUTILITIES_H_
...
{
	/**
	 * Various string related, static utility methods
	 *
	 */
	class StringUtilities
	{
		public:
			 ...
			 */
			static std::vector<std::string>& Split(const std::string& str, const std::string& delim, std::vector<std::string>& tokens) ;

			//---------------------------------------------------------------------------------------//

		private:
			StringUtilities() {} ;
			StringUtilities(const StringUtilities&) {} ;
...
#endif /* _CUTIL_STRINGUTILITIES_H_ */
